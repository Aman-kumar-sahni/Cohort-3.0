      ...
      <div className="flex min-h-[calc(100vh-3rem)] items-center justify-center">
        ...
        <div className="w-full max-w-md rounded-3xl border border-black/10 bg-white p-6 shadow-[0_25px_70px_rgba(0,0,0,0.10)] sm:p-8 md:p-10">
          ...
          <form className="mt-8 space-y-4">
            ...
            <button
              type="submit"
              className="group mt-2 flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-black text-sm font-semibold text-white shadow-lg shadow-black/10 transition-all duration-300 hover:-translate-y-0.5 hover:bg-neutral-800 hover:shadow-xl active:translate-y-0"
            >
