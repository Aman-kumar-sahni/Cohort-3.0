...
const ProductCard = ({ product }) => {
  return (
    <article className="group w-full max-w-sm overflow-hidden rounded-3xl border border-black/10 bg-white shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
      ...
      <div className="p-5 sm:p-6">
        ...
        {/* Title */}
        <h2 className="mt-2 line-clamp-2 min-h-[3.5rem] text-lg font-bold leading-7 text-black sm:text-xl">
          {product.title}
        </h2>
